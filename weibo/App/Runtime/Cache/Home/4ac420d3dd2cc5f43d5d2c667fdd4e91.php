	...
	<div class="header_main">
		...
		<div class="person">
			<ul>
				...
				<li class="app">消息
					<dl class="list">
						<dd><a href="<?php echo U('Setting/refer');?>">@回答我
						<!--
...
<div id="main">
	...
	<div class="main_left">
		...
		<div class="weibo_content">
			<ul>
				<li><a href="javascript:void(0)" class="selected">我关注的课程<i class="nav_arrow"></i></a></li>
			...
			<?php if(is_array($topicList)): $i = 0; $__LIST__ = $topicList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i; if(empty($obj["reid"])): ?><dl class="weibo_content_data">
				...
				<?php if(empty($obj["face"])): if(empty($obj["domain"])): ?><a href="<?php echo U('Space/index', array('id'=>$obj['uid']));?>"><img src="/weibo/Public/Home/img/small_face.jpg" border="0" alt=""></a>
					<?php else: ?>
						<a href="/weibo/i/<?php echo ($obj["domain"]); ?>"><img src="/weibo/Public/Home/img/small_face.jpg" border="0" alt=""></a><?php endif; ?>
				<?php else: ?>
					<?php if(empty($obj["domain"])): ?><a href="<?php echo U('Space/index', array('id'=>$obj['uid']));?>"><img src="/weibo/<?php echo ($obj["face"]); ?>" border="0" alt=""></a>
					<?php else: ?>
						<a href="/weibo/i/<?php echo ($obj["domain"]); ?>"><img src="/weibo/<?php echo ($obj["face"]); ?>" border="0" alt=""></a><?php endif; endif; ?>
				</a></dt>
				<dd>
					<h4>
					...
					<?php switch($obj["count"]): case "0": break;?>
						...
						<?php default: ?>
							<?php $__FOR_START_21391__=0;$__FOR_END_21391__=$obj['count'];for($i=$__FOR_START_21391__;$i < $__FOR_END_21391__;$i+=1){ ?><div class="imgs"><img src="/weibo/<?php echo ($obj['images'][$i]['thumb']); ?>" unfold-src="/weibo/<?php echo ($obj['images'][$i]['unfold']); ?>" source-src="/weibo/<?php echo ($obj['images'][$i]['source']); ?>" alt=""></div><?php } endswitch;?>
					<div class="footer">
						...
						<div class="com_box re_com_box" style="display:none;">
							...
							<input class="com_button" type="button" value="回答">
				...
				<dd>
					...
					<div class="re_content" style="overflow:auto;">
						...
						<?php switch($obj["recontent"]["count"]): case "0": break;?>
							...
							<?php default: ?>
								<?php $__FOR_START_22044__=0;$__FOR_END_22044__=$obj['recontent']['count'];for($i=$__FOR_START_22044__;$i < $__FOR_END_22044__;$i+=1){ ?><div class="imgs"><img src="/weibo/<?php echo ($obj['recontent']['images'][$i]['thumb']); ?>" unfold-src="/weibo/<?php echo ($obj['recontent']['images'][$i]['unfold']); ?>" source-src="/weibo/<?php echo ($obj['recontent']['images'][$i]['source']); ?>" alt=""></div><?php } endswitch;?>
						<div class="footer">
							<span class="time"><?php echo ($obj["recontent"]["time"]); ?> 该微博共被转播了<?php echo ($obj["recontent"]["recount"]); ?>次</span>
						</div>
					</div>
					<div class="footer">
						<span class="time"><?php echo ($obj["time"]); ?></span>
				...
				<dl class="weibo_content_data">
					...
					<dd>
						...
						<div class="footer">
							...
							<span class="handler">赞(0) | 转播 | 回答 | 收藏</span>
						</div>
					</dd>
				</dl>
			</div>
